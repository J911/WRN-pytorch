...
parser.add_argument('--layer', default=4, help='')
parser.add_argument('--widen_factor', default=2, help='')
...
parser.add_argument('--drop_rate', default=0.3, help='')
...
# net = resnet(5, 10)
net = wide_resnet(args.layer, args.widen_factor, 10, args.drop_rate)
net = net.to(device)
if device == 'cuda':
